...
\section{} %8.5
	...
	\subsection{}
	Jeder Prozess ist ein Kausalnetz mit einem Abbildungspaar, welches die Bedingungen auf Stellen und die Ereignisse auf Transitionen abbildet. Das zu einem Prozess gehörende Kausalnetz ist vorgängerendlich.
	
	Es gibt jedoch auch Kausalnetze, die nicht vorgängerendlich sind und damit keine Prozesse.
	\subsection{}
	%TODO
\end{document}
