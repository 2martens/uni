...
\section{} %8.4
	...
	\begin{tikzpicture}[node distance=1cm]
		...
		\node[ellipse] (m12) [left=of m11] {4p2 + 2p3};
		...
		\path[->] (m0) edge node[right] {a} (m1)
			...
			(m15) edge node[below left=0.5 and 0.6] {b} (m16)
			(m13) edge node[above left] {a} (m9)
			(m14) edge node[below left=0.1 and 0.1] {c} (m16)
			(m13) edge node[above left=0.5 and 0.6] {b} (m17)
			(m16) edge node[left] {b} (m18)
			(m16) edge node[below right] {a} (m10)
			(m17) edge node[left] {a} (m19)
			(m18) edge node[right] {b} (m20);
	\end{tikzpicture}
